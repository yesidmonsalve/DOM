...
const generarContenidoSeccion1 = () => {
    const seccion1 = document.createElement('div');
    seccion1.classList.add('Tarjeta');
    
    const titulo = document.createElement('h2');
    titulo.textContent = 'Restas';
    seccion1.appendChild(titulo);
    
    const parrafo = document.createElement('p');
    parrafo.textContent = 'En este apartado puedes realizar Restas que necesiten resolver.';
    seccion1.appendChild(parrafo);

    // Crear elemento de imagen y establecer su fuente
    const imagen = document.createElement('img');
    imagen.classList.add('Img1')
    imagen.src = './img/Resta.png';// Ejemplo de imagen
...
export { generarContenidoSeccion1 };
